...
{
    DBG("__tptz__GetServiceCapabilities\n");
    return SOAP_OK;
}
...
{
    DBG("__tptz__GetConfigurationOptions\n");
    return SOAP_OK;
}
...
{
    DBG("__tptz__SendAuxiliaryCommand\n");
    return SOAP_OK;
}
...
{
    DBG("__tptz__GetPresetTourOptions\n");
    return SOAP_OK;
}
...
{
    DBG("__tptz__GetCompatibleConfigurations\n");
    return SOAP_OK;
}
...
{
    DBG("__tptz__MoveAndStartTracking\n");
    return SOAP_OK;
}
